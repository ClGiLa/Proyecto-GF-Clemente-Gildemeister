...
```{python}
nvda = yf.Ticker("NVDA")
# Obtener las fechas de vencimiento de opciones
opciones = nvda.options
print("Fechas de vencimiento:", opciones)

# Obtener los datos de opciones para una fecha específica
opciones_data = nvda.option_chain(opciones[0])  # Cambia el índice según la fecha de vencimiento deseada
calls = opciones_data.calls
puts = opciones_data.puts
```
...
option_price = binomial_model(cu, p, cd, r)
